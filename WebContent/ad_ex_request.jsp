...
<section class="page-header" style="padding-top:300px;margin-top:0px">			<!-- padding-top:300px -->
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">전시신청</h1>
					<ol class="breadcrumb">
						<li><a href="index.jsp">Home</a></li>
						<li class="active">전시신청</li>
					</ol>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="contact-form col-md-6 " >
					<form name="joinForm" method="post" action="joinHandling.jsp" role="form" onsubmit="return checkValue()">
						...
						<div class="form-group">
							<ul class="join_list">
								<li class="join_field">전시장</li>
								
								<li class="join_input">
									<select name="place">
									  <option value="한가람 미술관">한가람 미술관</option>
						...
						<div class="form-group">
							<ul class="join_list">
								...
								<li class="join_input"><input type="text" placeholder="전시시작일을 입력하여 수정하세요. ex)18.06.09" class="form-control" name="sdate" id="edate"></li>
							</ul>
						</div>
						<div class="form-group">
							<ul class="join_list">
						...
						<div class="form-group">
							<ul class="join_list">
								<li class="join_field">전시장소</li>
								<li class="join_input"><input type="text" placeholder="전시장소를 입력하여 수정하세요. " class="form-control" name="place" id="place"></li>
							</ul>
						</div>
						<div class="form-group">
							<ul class="join_list">
								<li class="join_field">전시가격</li>
								<li class="join_input"><input type="text" placeholder="가격  ex)100000" class="form-control" name="priceSeatR" id="priceSeatR"></li>
							</ul>
						</div>
						...
						<div id="cf-submit" class="ad_btn_list">
							<input type="submit" class="btn btn-transparent ad_btn" value="전시신청">
