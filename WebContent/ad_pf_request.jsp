		...
		<div class="container">
			<div class="row">
				...
				<div class="contact-form col-md-6 " >
					<form name="joinForm" method="post" action="ad_pf_requestHandling.jsp" role="form" onsubmit="return checkValue()">
				...
				<% 
					...
					if(msg.equals("1")){
						out.println("<center><h2> ☆★ 공연신청이 완료되었습니다 ★☆ </h2></center>");
					}
					else{
