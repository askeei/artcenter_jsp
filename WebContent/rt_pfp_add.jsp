...
<section class="page-header" style="padding-top:300px;margin-top:0px">			<!-- padding-top:300px -->
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">공연장등록</h1>
					<ol class="breadcrumb">
						<li><a href="index.jsp">Home</a></li>
						<li class="active">공연장등록</li>
					</ol>
				</div>
			</div>
		</div>
				...
				<div class="contact-form col-md-6 " >
					<form name="joinForm" method="post" action="joinHandling.jsp" role="form" onsubmit="return checkValue()">
						<div class="form-group">
							<ul class="join_list">
								<li class="join_field">공연장이름</li>
								<li class="join_input">
									<div class="input-group subscription-form">
										<input type="text" placeholder="공연장 이름을 입력하세요" class="form-control" name="name" id="name" onchange="ch(this)">
									</div>
						...
						<div class="form-group">
							<ul class="join_list">
								<li class="join_field">R석좌석수</li>
								<li class="join_input"><input type="text" placeholder="R석좌석수를 입력하세요." class="form-control" name="priceSeatR" id="priceSeatR"></li>
							</ul>
						</div>
						
						<div class="form-group">
							<ul class="join_list">
								<li class="join_field">S석좌석수</li>
								<li class="join_input"><input type="text" placeholder="S석좌석수를 입력하세요." class="form-control" name="priceSeatS" id="priceSeatS"></li>
							</ul>
						</div>
						<div class="form-group">
							<ul class="join_list">
								<li class="join_field">A석좌석수</li>
								<li class="join_input"><input type="text" placeholder="A석좌석수를 입력하세요." class="form-control" name="priceSeatA" id="priceSeatA"></li>
							</ul>
						</div>
						...
						<div id="cf-submit" class="ad_btn_list">
							<input type="submit" class="btn btn-transparent ad_btn" value="공연장등록">
