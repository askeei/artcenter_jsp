...
<section class="page-header sub_page" style="padding-top:300px;margin-top:0px">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">공연개시조회</h1>
					<ol class="breadcrumb">
						<li><a href="#">Home</a></li>
						<li class="active">공연개시조회</li>
					</ol>
				</div>
			</div>
		</div>
                ...
                <table class="table pf_list">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="" style="vertical-align:middle; ">
                     	 <button type="button" class="pf_list_btn" onclick="javascript:location.href='rt_pf_modify_op.jsp?name=<%=a.getName()%>'">수정</button>
                      </td>
                      <td class="" style="vertical-align:middle; ">
