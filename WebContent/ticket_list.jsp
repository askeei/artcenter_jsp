            ...
            <div class="product-list">
              <form method="post">
                <table class="table">
                  ...
                  if(SystemController.tDao.selectTicket(id).size() == 0){//0
                  ...
                  <tbody>
                    ...
                    for(TicketDTO ticket : SystemController.tDao.selectTicket(id)){
                    ...
                    <tr class="midd" >
                      ...
                      <td style="vertical-align:middle">
                        <a style="width:100%;" class="cancel_btn" href="ticket_cancel.jsp?tno=<%=ticket.getTno() %>" onclick="return deleteConfirm()">취소</a>
                      </td>
                    </tr>
